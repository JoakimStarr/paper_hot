...
from app.routers import system, papers, ai, network, crawler, topic, personal, dashboard, producer, logs, assistant, tracking, workbench, topic_ideas
...
router.include_router(topic_ideas.router)
